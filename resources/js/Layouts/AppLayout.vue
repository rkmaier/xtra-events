                    ...
                    <div class="flex justify-between h-16">
                        ...
                        >
                            <div class="ms-3 relative">
                                <!-- Teams Dropdown -->
                                <Dropdown
                                    v-if="$page.props.jetstream.hasTeamFeatures && $page.props.auth && $page.props.auth.user"
                                    align="right"
                                    width="60"
                                >
                                    <template #trigger>
                            ...
                            <div class="ms-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <DropdownLink :href="route('events.manage')">
                                            Manage Events
                                        </DropdownLink>
                        ...
                        <!-- Desktop auth links when not logged in -->
                        <div
                            v-else
                            class="hidden sm:flex sm:items-center sm:ms-6 space-x-4"
                        >
                            <Link
